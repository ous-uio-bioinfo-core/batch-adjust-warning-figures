...
\begin{figure}[!p]
\centering\includegraphics[width=13cm]{../reanalysis/Leek2012/leekrandomdatapvalues.pdf}
\caption{
A sanity checks were the recommended use of ComBat fails. Adapted from the user guide in the sva package. Real data are substituted with random numbers from a normal distribution, but the batch/group design is retained. ComBat is applied followed by a F-test.
