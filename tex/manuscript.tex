...
When ComBat was later incorporated in the sva package (\citealp{Leek2012}), batch adjustment without covariates was no longer a default as specification of covariates became a requirement. Although specification of a null model was still possible, the help file specifies that this should contain ``outcome of interest and other covariates besides batch''. Thus, we expect this usage to have grown more common.
