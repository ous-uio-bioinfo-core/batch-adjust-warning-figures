...
genes, yielding hundreds of differentially expressed probes (Table S5, \citealp{Towfic2014}).
...
batch effect in \texttt{limma}, only 9 genes were found
($\text{FDR}<0.05$). The sanity check  outlined above with random numbers
