...
\end{equation}
where $\tilde q$ and $\tilde\sigma^2$ are as computed in the appendix and satisfy $\tilde q\tilde\sigma^2\ge q\sigma^2$ and $\tilde q\le q$ with equalities if and only if the groups are perfectly balanced between the batches.
